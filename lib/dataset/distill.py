...
class AlaskaDataIter():
    ...
    def butter_lowpass_filter(self, data, cutoff_freq=20, sampling_rate=200, order=2):
    ...
    def get_eeg(self, dp, is_training):
        ...
        if is_training:
            if random.uniform(0,1)<0.5:
                ...
                waves = self.brain_lead_reverse(waves)
        else:
            waves = self.brain_lead(waves)
        ...
        waves = mne.filter.notch_filter(waves, 200,[20,60], verbose=False)
